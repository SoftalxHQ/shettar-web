 ...
 * useAccountProfile
 *
 * Fetches the current account's profile from GET /account_details (auth required).
 * Returns the profile data, a loading flag, an error string, and a refetch function.
 * Used by UserDetails, AccountWallet, ProfileProgress, PersonalInformation.
 */
