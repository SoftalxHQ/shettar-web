...
type BookingPassProps = {
  booking: GuestReservation;
  onCopyCode?: () => void;
  hideInteractive?: boolean;
};

const BookingPass = forwardRef<HTMLDivElement, BookingPassProps>(function BookingPass(
  { booking, onCopyCode, hideInteractive = false },
  ref,
) {
  ...
  return (
    <div className="booking-pass" ref={ref}>
      <div className="booking-pass-header">
        ...
        <div className="d-flex align-items-center gap-2 flex-wrap">
          ...
          {onCopyCode && !hideInteractive ? (
            <button
              type="button"
              className="booking-pass-copy no-print"
              onClick={onCopyCode}
      ...
      <div className="booking-pass-body">
        ...
        {guestName ? <MetaRow label="Guest" value={guestName} /> : null}
      ...
      {bookedForSomeone && (guestEmail || guestPhone) ? (
